...
<div class="flex flex-row relative w-full sm:max-w-[343px]">
  ...
  <input
    type="text"
    {placeholder}
    class="input border border-odd-gray-500 focus:outline-[#50F1C9] bg-odd-gray-0 text-odd-gray-300 placeholder-odd-gray-300 w-full h-8 pl-10 relative z-0 rounded-full"
