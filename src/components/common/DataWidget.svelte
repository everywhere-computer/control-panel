...
on:click_outside={handleClickOutside} -->
  <div
    class="fixed right-4 bottom-24 z-50 p-4 max-w-[320px] pt-8 bg-odd-gray-0 dark:bg-base-100 border-odd-gray-400 border rounded-sm text-body-sm"
  >
...
<button
  class="toggle-trigger fixed right-4 bottom-4 z-[60] w-16 h-16 hover:opacity-[.92] transition duration-200 ease-in-out"
